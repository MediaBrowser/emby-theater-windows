...
{
    /// <summary>
    /// Interaction logic for LatestAlbums.xaml
    /// </summary>
    public partial class LatestAlbums : BaseItemsControl
    {
        public LatestAlbums(BaseItemDto parent, Model.Entities.DisplayPreferences displayPreferences, IApiClient apiClient, IImageManager imageManager, ISessionManager sessionManager, INavigationService navigationManager, IThemeManager themeManager, IPresentationManager appWindow)
