...
namespace MediaBrowser.Theater.DefaultTheme.Home
{
    ...
    public static class ApiClientExtensions
    {
        ...
        {
            string url = apiClient.GetApiUrl("MBT/DefaultTheme/TV?userId=" + userId + "&ComedyGenre=" + ComedyGenre + "&RomanceGenre=" + RomanceGenre + "&TopCommunityRating=" + TopTvCommunityRating + "&NextUpEpisodeLimit=15&LatestEpisodeLimit=9&ResumableEpisodeLimit=3");
        ...
        {
            string url = apiClient.GetApiUrl("MBT/DefaultTheme/Favorites?userId=" + userId);
        ...
        {
            string url = apiClient.GetApiUrl("MBT/DefaultTheme/Games?userId=" + userId + "&RecentlyPlayedGamesLimit=3");
