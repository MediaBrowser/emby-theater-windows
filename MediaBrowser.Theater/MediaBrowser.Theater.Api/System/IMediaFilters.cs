...
namespace MediaBrowser.Theater.Api.System
{
    ...
    public interface IMediaFilters
    {
        ...
        bool IsMadVrInstalled();

        bool IsReClockInstalled();

        Task InstallReClock(IProgress<double> progress, CancellationToken cancellationToken);
    }
}