...
namespace MediaBrowser.Theater.DefaultTheme.Home.ViewModels.TV
{
       ...
       : BaseViewModel, IKnownSize, IHomePage
    {
        ...
        public ResumeEpisodesViewModel(Task<TvView> tvViewTask, IApiClient apiClient, IImageManager imageManager, IServerEvents serverEvents, INavigator navigator, ISessionManager sessionManager)
        {
