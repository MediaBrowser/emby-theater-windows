...
namespace MediaBrowser.Theater.DefaultTheme.ItemDetails.ViewModels
{
    ...
    {
        private const double PosterHeight = 400 - HomeViewModel.TileMargin * 0.5;
        ...
        public Size Size
        {
            get
            {
                ...
                return new Size(width*(Items.First().Size.Width + 2*HomeViewModel.TileMargin) + HomeViewModel.SectionSpacing, 900);
            }
        }
        ...
        {
            var query = new SimilarItemsQuery { Id = _item.Id, UserId = _sessionManager.CurrentUser.Id, Limit = 4 };
