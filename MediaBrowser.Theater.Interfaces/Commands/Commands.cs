namespace MediaBrowser.Theater.Interfaces.Commands
{
    public enum Command
    {
        ...
        NextChapter,        // Next Media Chapter
        PreviousChapter,    // Prev Media Chapter
        NextTrack,          // Next track or media item in a multi item list
        PreviousTrack,      // Previous track or media item in a multi item list
        NextTrackOrChapter,       // Next Media Chapter - next chapter for video, Next track for audio
        PreviousTrackOrChapter,   // Prev Media Chapter - Prev chapter for video, Prevt track for audio
        Seek,
        Left,
        Right,
        Up,
