...
{
    /// <summary>
    /// Interaction logic for LatestMusicVideos.xaml
    /// </summary>
    public partial class LatestMusicVideos : BaseItemsControl
    {
        public LatestMusicVideos(BaseItemDto parent, Model.Entities.DisplayPreferences displayPreferences, IApiClient apiClient, IImageManager imageManager, ISessionManager sessionManager, INavigationService navigationManager, IThemeManager themeManager, IPresentationManager appWindow)
