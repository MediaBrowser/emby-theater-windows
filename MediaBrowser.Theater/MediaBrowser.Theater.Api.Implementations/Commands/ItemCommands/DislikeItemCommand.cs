...
{
    public class DislikeItemCommand : IItemCommand
    {
        private readonly IConnectionManager _connectionManager;
        private readonly ISessionManager _sessionManager;

        public DislikeItemCommand(IConnectionManager connectionManager, ISessionManager sessionManager)
        {
        ...
        public async Task Initialize(BaseItemDto item)
        {
            ...
            ExecuteCommand = new RelayCommand(o => {
                ...
                if (item.UserData.Likes.HasValue) {
                    ...
                    api.UpdateUserItemRatingAsync(item.Id, _sessionManager.CurrentUser.Id, false);
