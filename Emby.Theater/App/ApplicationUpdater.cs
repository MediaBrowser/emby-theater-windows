...
namespace Emby.Theater.App
{
    public class ApplicationUpdater
    {
        ...
        public void UpdateApplication(IApplicationPaths appPaths, string archive, ILogger logger)
        {
            ...
            var args = string.Format("product={0} archive=\"{1}\" caller={2} pismo=false version={3} service={4} installpath=\"{5}\"", product, archive, Process.GetCurrentProcess().Id, version, string.Empty, appPaths.ProgramDataPath);
