...
namespace MediaBrowser.Plugins.DefaultTheme.Controls.Details
{
    ...
    public partial class ItemTrailers : BaseDetailsControl
    {
        ...
        /// </summary>
        public ItemTrailers(IApiClient apiClient, IImageManager imageManager, ISessionManager sessionManager, IPresentationManager presentation)
        {
        ...
        protected override async void OnItemChanged()
        {
            ...
            try
            {
                result = await _apiClient.GetLocalTrailersAsync(_sessionManager.CurrentUser.Id, Item.Id);
            }
            catch (HttpException)
            {
